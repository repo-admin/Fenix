...
namespace Fenix
{
	public partial class ManuallyShipment : BasePage
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			try
			{
				...
				((Fenix.BasePage.User)(Session["Logistika_CURRENT_USER"])).Lastname.ToString() + "<br />" + "Požadavek na stránku ManuallyShipment.aspx" + "<br />",
