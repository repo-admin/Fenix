<%@ Page Title="" Language="C#" MasterPageFile="~/Reception.master" AutoEventWireup="true" CodeBehind="KiRelease.aspx.cs" Inherits="Fenix.KiRelease" %>
						...
						<tr>
							...
							<td style="vertical-align: bottom; height: 30%;">
								...
								<asp:DropDownList ID="ddlItemVerKitFlt" runat="server">
									...
									<asp:ListItem Value="1"  Selected="True" Text="Kits"></asp:ListItem>
								</asp:DropDownList>&nbsp;&nbsp;
							</td>
							<td style="vertical-align: bottom; height: 30%;">
						...
						<tr>
							...
							<td colspan="2">
								...
								<asp:DropDownList ID="ddlTrideniFlt" runat="server" Width="60px">
									...
									<asp:ListItem Value="cdlItemsId">ID Item/kit</asp:ListItem>
