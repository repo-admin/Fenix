<%@ Page Title="" Language="C#" MasterPageFile="~/VratRep.master" AutoEventWireup="true" CodeBehind="VrCardStockItems.aspx.cs" Inherits="Fenix.VrCardStockItems" %>
				...
				<div id="divFilter" runat="server" visible="true">
					<table style="border: thin solid #0000FF;">
						...
						<tr>
							...
							<td style="vertical-align: bottom; height: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;
                                  <%--<asp:ImageButton ID="excelSmall_button" runat="server" ImageUrl="~/img/excelSmall.png" OnClick="excelSmall_button_Click" BorderWidth="0px" CausesValidation="False" ImageAlign="Bottom" />--%>										
							</td>
							<td style="vertical-align: bottom; height: 30px;">&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
							</td>
							<td style="vertical-align: bottom; height: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;
								<asp:Button ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="Filtr" Width="59px" />
							</td>
						</tr>
